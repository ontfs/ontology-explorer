...
import com.github.ontio.SimpleCORSFilter;
...
public class BaseDruidConfig {
    ...
    public ServletRegistrationBean getServletRegistrationBean(String username, String password, String logSlowSql) throws Exception {
        ServletRegistrationBean reg = new ServletRegistrationBean();
        reg.setServlet(new StatViewServlet());
        reg.addUrlMappings("/explorer-druid-monitor/*");//配置访问URL
        reg.addInitParameter("loginUsername", username);  //配置用户名
        reg.addInitParameter("loginPassword", password);  //配置用户名
